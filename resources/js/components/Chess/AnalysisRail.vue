...
<template>
    <aside class="rail">
        <div class="flex gap-px border-b border-line px-3.5">
            <button
                v-for="item in TABS"
                :key="item.key"
                type="button"
        ...
        <!-- Moves ------------------------------------------------------ -->
        <div v-if="tab === 'moves'" class="flex min-h-0 flex-1 flex-col">
            <div
            ...
            <div
                ref="moveListEl"
                class="max-h-72 min-h-0 flex-1 overflow-y-auto py-1.5 xl:max-h-none"
            >
                <p
        ...
        <!-- Captured --------------------------------------------------- -->
        <div v-else class="min-h-0 flex-1 overflow-y-auto p-3.5">
        ...
        <div class="shrink-0 border-t border-line-soft px-3.5 pt-3 pb-3.5">
            <div class="mb-1.5 flex items-center justify-between">
                ...
                <button type="button" class="btn btn--tiny" @click="copyFen">
