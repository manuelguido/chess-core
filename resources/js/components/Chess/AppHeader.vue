...
<template>
    <header
        class="flex h-13 shrink-0 items-center border-b border-line bg-bg-panel"
    >
        <div class="game-container flex items-center gap-3.5">
            ...
            <span class="badge ml-auto sm:ml-0">
