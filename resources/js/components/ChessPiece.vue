    ...
    >
        ...
        <template v-if="type === 'q'">
            ...
            >
                ...
                -->
                <path d="M9 26C17.5 24.5 30 24.5 36 26L38 14L31 25L30.7 10.9L25.5 24.5L22.5 10L19.5 24.5L14.3 10.9L14 25L7 14Z" />
                <!-- Crown base + body -->
                ...
                <!-- Base bands -->
                <path d="M11.5 30c3.5-1 18.5-1 22 0M12 33.5c6-1 15-1 21 0" stroke-linecap="butt" fill="none" />
            </g>
        ...
        <template v-if="type === 'k'">
            ...
            >
                ...
                <!-- robe -->
                <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4v5-5c-2.5-7.5-12-10.5-16-4-3 6 6 10.5 6 10.5v7" />
            </g>
            <!-- robe creases -->
            <path
